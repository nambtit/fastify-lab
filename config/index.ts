...
export const APP_CONFIG = {
  ...
  ACCESS_TOKEN_EXPIRATION_MS: parseInt(
    process.env.ACCESS_TOKEN_EXPIRATION_MS || (15 * 60 * 1000).toString(),
    10,
  ), // 15 minutes
  REFRESH_TOKEN_EXPIRATION_MS: parseInt(
    process.env.REFRESH_TOKEN_EXPIRATION_MS ||
      (7 * 24 * 60 * 60 * 1000).toString(),
    10,
  ), // 7 days
  PASSWORD_RESET_TOKEN_EXPIRATION_MS: parseInt(
    process.env.PASSWORD_RESET_TOKEN_EXPIRATION_MS ||
      (60 * 60 * 1000).toString(),
    10,
  ), // 1 hour
};
